...
movies.forEach(movie => {
    ...
    <p><strong>Rating:</strong> <span aria-label="${movie.stars.length} out of 5 stars"><span aria-hidden="true">${movie.stars}</span></span></p>
...
//   <p><strong>Rating:</strong> <span aria-label="4 out of 5 stars"><span aria-hidden="true">⭐⭐⭐⭐</span></span></p>
